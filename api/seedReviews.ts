// Seed reviews for the serverless function.
// Kept inside api/ because Vercel only packs the api/ folder into the lambda,
// and an import into ../src would fail at runtime (ERR_MODULE_NOT_FOUND).
...
export const INITIAL_REVIEWS: ApiReview[] = [
  {
    id: "r1",
    stars: 5,
    name: "أحمد السيد",
