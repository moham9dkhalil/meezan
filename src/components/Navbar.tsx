...
export function Navbar({
  ...
  const categorizedNavItems = [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "trust" as ActiveTab, label: isEn ? "Trust & Plans" : "الثقة وخطط التعلم", icon: ShieldCheck, desc: "المراجع، الشهادات، الخصوصية وخطط الاشتراك" },
  ...
  const mobileAllItems = [
    ...
    { id: "trust" as ActiveTab, label: isEn ? "Trust & Plans" : "الثقة والخطط", icon: ShieldCheck },
